...
- vRain是该復刻計劃的主要工具，此外還有古籍印章製作工具 [vYinn殷人](https://github.com/shanleiguang/vYinn) 、古棋譜製作工具 [vQi](https://github.com/shanleiguang/vQi) 、古籍掃描圖像變形糾正工具[vModou墨斗](https://github.com/shanleiguang/vModouPreview)以及其他傳統文化文創工具，如天地人三才傳統曆法筆記本 [v3Cai](https://github.com/shanleiguang/v3CaiPreview)等。
...
## 赞助支持 Sponsorship
### 更多有趣內容，移步[**這裡**](https://github.com/shanleiguang/vRain/wiki/Private)  
...
>>微信或郵件諮詢答疑，包括運行環境調試、使用協助、代碼解讀、定製化開發及合作等相關問題；  
>>代碼持續更新，註釋更詳細；  
>>豐富古籍排版實用標籤，如**正文與批注字體可分別設置、正文字體縮放、文字添加底框（圓角方框/圓形框）、正文字符右側圈注點注、文本預處理**等；  
>>更多模擬背景圖，如甲骨、碑拓、竹簡、做舊、手機壁紙等； 
>>重構字符位置書組，實現族谱多欄排版的特殊版本；  
>>高質量樣例，如vRain+vYinn結合應用案例；  
>>**訂購作者自製古籍數字復刻全套成書**。  
![image width=>"500"](https://github.com/shanleiguang/vRain/blob/main/sponsor_new.png)  
